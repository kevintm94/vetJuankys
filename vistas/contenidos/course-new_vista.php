...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>course-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CURSO</a>
        </li>
        <li>
                ...
                <div class="row">
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9-]{1,10}" class="form-control" name="curso_codigo_reg" id="curso_codigo" maxlength="10" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,50}" class="form-control" name="curso_nombre_reg" id="curso_nombre" maxlength="50" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="curso_sesiones" class="bmd-label-floating">Número de Sesiones<font COLOR="red">*</font></label>
                            <input type="number" min="1" max="100" class="form-control" name="curso_sesiones_reg" id="curso_sesiones" maxlength="3" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="curso_precio" class="bmd-label-floating">Precio<font COLOR="red">*</font></label>
                            <input type="number" min="0" max="1000" step="0.1" class="form-control" name="curso_precio_reg" id="curso_precio" maxlength="4" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-9">
                        <div class="form-group">
                            <label for="curso_detalle" class="bmd-label-floating">Detalle</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="curso_detalle_reg" id="curso_detalle" maxlength="190">
                        </div>
                    </div>
                </div>
            </div>
