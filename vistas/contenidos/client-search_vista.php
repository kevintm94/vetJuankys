        ...
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <h5>¿Qué cliente estas buscando?</h5>
                    <div class="form-group">
                        <label for="inputSearch" class="bmd-label-floating">CI, nombres o apellidos</label>
...
<div class="container-fluid">
    <?php
        ...
        echo $ins_cliente->paginador_cliente_controlador($pagina[1], PAGINA, $_SESSION['rol_auth'], $pagina[0], $_SESSION['busqueda_cliente']);
    ?>
</div>
<?php } ?>