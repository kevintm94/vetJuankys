        ...
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <h5>¿Qué artículo estas buscando?</h5>
                    <div class="form-group">
                        <label for="inputSearch" class="bmd-label-floating">Código, nombre o fabricante</label>
...
<div class="container-fluid">
    <?php
        ...
        echo $ins_item->paginador_item_controlador($pagina[1], PAGINA, $_SESSION['rol_auth'], $pagina[0], $_SESSION['busqueda_item']);
    ?>
</div>
<?php } ?>