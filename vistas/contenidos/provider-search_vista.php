...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>provider-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PROVEEDOR</a>
        </li>
    </ul>	
</div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <h5>¿Qué proveedor estas buscando?</h5>
                    <div class="form-group">
                        <label for="inputSearch" class="bmd-label-floating">nombre o telefono</label>
...
<div class="container-fluid">
    <?php
        ...
        echo $ins_proveedor->paginador_proveedor_controlador($pagina[1], PAGINA, $_SESSION['rol_auth'], $pagina[0], $_SESSION['busqueda_proveedor']);
    ?>
</div>
<?php } ?>