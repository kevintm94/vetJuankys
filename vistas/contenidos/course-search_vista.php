<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CURSO
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>course-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CURSO</a>
        </li>
    </ul>
</div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <h5>¿Qué curso estas buscando?</h5>
...
<div class="container-fluid">
    <?php
        ...
        echo $ins_curso->paginador_curso_controlador($pagina[1], PAGINA, $_SESSION['rol_auth'], $pagina[0], $_SESSION['busqueda_curso']);
    ?>
</div>
<?php } ?>