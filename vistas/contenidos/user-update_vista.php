<?php
    if ($lc->encryption($_SESSION['id_auth']) != $pagina[1]) {
...
<div class="container-fluid">
    ...
    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[0-9-]{7,10}" class="form-control" name="usuario_ci_up" id="usuario_ci" maxlength="10" value="<?php echo $campos['CI']; ?>" required ="">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_nombre_up" id="usuario_nombre" maxlength="35"value="<?php echo $campos['Nombres']; ?>">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[0-9()+]{7,8}" class="form-control" name="usuario_telefono_up" id="usuario_telefono" maxlength="8" value="<?php echo $campos['Telefono']; ?>">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_direccion" class="bmd-label-floating">Dirección</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="usuario_direccion_up" id="usuario_direccion" maxlength="190" value="<?php echo $campos['Direccion']; ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control" name="usuario_usuario_up" id="usuario_usuario" maxlength="35" value="<?php echo $campos['Usuario']; ?>">
                        </div>
                    </div>
                    <?php if ($_SESSION['rol_auth'] == 1 && $campos['IdEmpleados'] != 1) { ?>
                    <div class="col-12">
                        <div class="form-group">
        ...
        <fieldset>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_clave_nueva_1" class="bmd-label-floating">Contraseña<font COLOR="red">*</font></label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_clave_nueva_2" class="bmd-label-floating">Repetir contraseña<font COLOR="red">*</font></label>
        ...
        <br><br><br>
        <fieldset>
            <legend><i class="fas fa-medal"></i> &nbsp; Nivel de privilegio<font COLOR="red">*</font></legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="usuario_privilegio_up">
                                <option value="1" <?php if ($campos['IdRoles'] == 1) { echo 'selected=""'; } ?>>Administrador <?php if ($campos['IdRoles'] == 1) { echo '(Actual)'; } ?></option>
                                <option value="2" <?php if ($campos['IdRoles'] == 2) { echo 'selected=""'; } ?>>Edición <?php if ($campos['IdRoles'] == 2) { echo '(Actual)'; } ?></option>
                                <option value="3" <?php if ($campos['IdRoles'] == 3) { echo 'selected=""'; } ?>>Registrar <?php if ($campos['IdRoles'] == 3) { echo '(Actual)'; } ?></option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <fieldset>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_admin" class="bmd-label-floating">Nombre de usuario<font COLOR="red">*</font></label>
                            <input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control" name="usuario_admin" id="usuario_admin" maxlength="35" required="" >
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="clave_admin" class="bmd-label-floating">Contraseña<font COLOR="red">*</font></label>
        ...
        <?php if ($lc->encryption($_SESSION['id_auth']) != $pagina[1]) { ?>
