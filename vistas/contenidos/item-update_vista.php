                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9-]{1,10}" class="form-control" name="item_codigo_up" value="<?php echo $campos['Codigo']; ?>" id="item_codigo" maxlength="10" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,50}" class="form-control" name="item_nombre_up" value="<?php echo $campos['Nombre']; ?>" id="item_nombre" maxlength="50" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="item_stock" class="bmd-label-floating">Stock<font COLOR="red">*</font></label>
                            <input type="number" min="0" max="1000" class="form-control" name="item_stock_up" value="<?php echo $campos['Stock']; ?>" id="item_stock" maxlength="4" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="item_precioc" class="bmd-label-floating">Precio Compra Unidad</label>
                            <input type="number" min="0" max="1000" step="0.01" class="form-control" name="item_precioc_up" value="<?php echo $campos['PrecioCompra']; ?>" id="item_precioc" maxlength="4">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="item_preciov" class="bmd-label-floating">Precio Venta Unidad<font COLOR="red">*</font></label>
                            <input type="number" min="0" max="1000" step="0.01" class="form-control" name="item_preciov_up" value="<?php echo $campos['PrecioVenta']; ?>" id="item_preciov" maxlength="4" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <?php
                            ...
                            echo $ins_item->proveedores_item_controlador("Actualizar", $campos['IdProveedores']);
                        ?>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="item_detalle" class="bmd-label-floating">Detalle</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="item_detalle_up" value="<?php echo $campos['Detalle']; ?>" id="item_detalle" maxlength="190">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="item_fabricante" class="bmd-label-floating">Fabricante o Marca<font COLOR="red">*</font></label>
                            <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,50}" class="form-control" name="item_fabricante_up" value="<?php echo $campos['Fabricante']; ?>" id="item_fabricante" maxlength="50">
                        </div>
                    </div>
                </div>
            </div>
