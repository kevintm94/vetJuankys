...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>user-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR EMPLEADO</a>
        </li>
    </ul>	
</div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <h5>¿Qué empleado estas buscando?</h5>
                    <div class="form-group">
                        <label for="inputSearch" class="bmd-label-floating">CI, nombres, apellidos o usuario</label>
...
<div class="container-fluid">
    <?php
        ...
        echo $ins_usuario->paginador_usuario_controlador($pagina[1], PAGINA, $_SESSION['rol_auth'], $_SESSION['id_auth'], $pagina[0], $_SESSION['busqueda_usuario']);
    ?>
</div>
<?php } ?>